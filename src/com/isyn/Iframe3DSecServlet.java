...
public class Iframe3DSecServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		// so just display JSP.
		// During load, get page from this jsp file "webCheckoutForm3DSec.jsp".
		request.getRequestDispatcher("/webCheckoutForm3DSec.jsp").forward(request, response);
	}
...
//			System.out.println("responding!!!");
			...
			// Populate hpciResponseMap with all the needed pairs of information
			hpciResponseMap.put("apiVersion", "1.0.1");
			hpciResponseMap.put("apiType", "pxyhpci");

			// The username is given by HostedPCI
			hpciResponseMap.put("userName", "sampqa1stgAdmAPI");

			// The passkey is given by HostedPCI
			hpciResponseMap.put("userPassKey", ".OQdIHVtVJSg-W-Zr40QQGY1xyhvGjUH");

			// Continue to populate hpciResponseMap with all the required
			// information
			hpciResponseMap.put("pxyCreditCard.cardType", cardType);
